      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary/5 items-center justify-center p-12 relative">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-bold text-foreground tracking-tight">DocFlow AI</span>
          </div>
          <h2 className="text-3xl font-bold text-foreground leading-tight">
            AI-Powered Document Tools for Everyone.
          </h2>
          <p className="text-muted-foreground">
          ...
          <div className="flex flex-wrap gap-2">
            {["AI Summarize", "PDF Merge", "OCR", "Translate", "Compress"].map((tag) => (
